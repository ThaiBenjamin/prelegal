  ...
  return (
    ...
    >
      ...
      <p className="mt-4 text-sm">
        ...
        consists of: (1) this Cover Page (&ldquo;<b>Cover Page</b>&rdquo;) and
        (2) the Common Paper Mutual NDA Standard Terms Version 1.0 (&ldquo;
        <b>Standard Terms</b>&rdquo;) identical to those posted at
      ...
      <hr className="my-8" style={{ borderTop: "1px solid #000" }} />
      ...
      <ol className="mt-4 list-decimal space-y-3 pl-6 text-sm">
        <li>
          ...
          (&ldquo;<b>MNDA</b>&rdquo;) allows each party (&ldquo;
          <b>Disclosing Party</b>&rdquo;) to disclose or make available
          information in connection with the <CrossRef>Purpose</CrossRef> which
          ...
          incorporating these Standard Terms (&ldquo;<b>Cover Page</b>&rdquo;).
          Each party is identified on the Cover Page and capitalized terms
          have the meanings given herein or on the Cover Page.
        </li>
        <li>
          <b>Use and Protection of Confidential Information.</b> The Receiving
          Party shall: (a) use Confidential Information solely for the{" "}
          <CrossRef>Purpose</CrossRef>; (b) not disclose Confidential
          ...
          know for the <CrossRef>Purpose</CrossRef>, provided these
        ...
        <li>
          <b>Exceptions.</b> The Receiving Party&rsquo;s obligations in this
          MNDA do not apply to information that it can demonstrate: (a) is or
        ...
        <li>
          <b>Disclosures Required by Law.</b> The Receiving Party may disclose
          Confidential Information to the extent required by law, regulation or
          regulatory authority, subpoena or court order, provided (to the
          extent legally permitted) it provides the Disclosing Party reasonable
          advance notice of the required disclosure and reasonably cooperates,
          at the Disclosing Party&rsquo;s expense, with the Disclosing
        ...
        <li>
          ...
          <CrossRef>MNDA Term</CrossRef>. Either party may terminate this MNDA
          for any or no reason upon written notice to the other party. The
          Receiving Party&rsquo;s obligations relating to Confidential
          Information will survive for the{" "}
          <CrossRef>Term of Confidentiality</CrossRef>, despite any expiration
        ...
        <li>
          <b>Proprietary Rights.</b> The Disclosing Party retains all of its
        ...
        <li>
          ...
          the laws of the State of {governingLaw}, without regard to the
          conflict of laws provisions of such State of {governingLaw}. Any
          legal suit, action, or proceeding relating to this MNDA must be
          instituted in the federal or state courts located in {jurisdiction}.
          Each party irrevocably submits to the exclusive jurisdiction of such
          courts in any such suit, action, or proceeding.
        </li>
        <li>
          <b>Equitable Relief.</b> A breach of this MNDA may cause irreparable
        ...
        <li>
          <b>General.</b> Neither party has an obligation under this MNDA to
          ...
          party&rsquo;s permitted successors and assigns. Waivers must be
          signed by the waiving party&rsquo;s authorized representative and
          ...
          an agreement in writing signed by both parties. Notices, requests
          and approvals under this MNDA must be sent in writing to the email
          or postal addresses on the Cover Page and are deemed delivered on
